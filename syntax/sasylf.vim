...
syn region slfCaseIs start=/\<case\>/ end=/\<is\>/ contains=@slfComments,slfCaseIsInner oneline
syn region slfCaseRuleIs start=/\<case\s\+rule\>/ end=/is/ contains=@slfComments,slfCaseIsInner,slfRule keepend
